...
const GalleryGrid = ({ items, favorites, onToggleFav, onView }: Props) => (
        ...
        <div className="aspect-square overflow-hidden relative">
          ...
          >
            <Icon
              name="Heart"
              size={16}
              className={favorites.includes(item.id) ? 'fill-neon-magenta text-neon-magenta' : 'text-muted-foreground'}
            />
          </button>
